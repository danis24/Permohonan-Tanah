              ...
              <table id="example1" class="table table-bordered table-striped" width="150%" >
                ...
                <?php foreach ($permohonan->result() as $key) { $i=1;?>
                    <tr>
                        ...
                        <td><a href="<?php echo base_url(); ?>index.php/Permohonan/edit/<?php echo $key->idpermohonan; ?>"><i class="fa fa-edit"></i> Ubah</a> <a href="#"><i class="fa fa-print"></i> Cetak Bukti</a></td>
                    </tr>
