    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-laptop"></i>
            <span>Data Tanah Desa Sukapura</span>
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
          </a>
          <ul class="treeview-menu">
                <li><a href="<?php echo base_url(); ?>index.php/Tanah/tambah"><i class="fa fa-circle-o"></i> Tambah Data Tanah</a></li>
                <li><a href="<?php echo base_url(); ?>index.php/Tanah"><i class="fa fa-circle-o"></i> Lihat Data Data Tanah</a></li>
            
          </ul>
        </li>
        
        <li class="treeview">
            <a href="<?php echo base_url(); ?>index.php/Permohonan/get_persetujuan">
            <i class="fa fa-laptop"></i>
            <span>Cek & Persetujuan Permohonan </span>
