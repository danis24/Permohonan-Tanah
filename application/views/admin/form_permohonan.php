                    ...
                    <form action="<?php echo base_url(); ?>index.php/Permohonan/proses_tambah" method="POST"  enctype="multipart/form-data" id="tambah_permohonan" width="100%">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="idpermohonan" id="idpermohonan" value="<?= $kodeunik; ?>" class="form-control" placeholder="ID permohonan" required="">
                                <div style="color: red; font-size: 10pt;" id="invalid-idpermohonan" class="error_msg"></div>
                            </div>

                            <div class="form-group">
                                <label>Nama Pemohon</label>
                                <input type="text" name="nama" id="nama" class="form-control" placeholder="Nama pemohon" required="">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nohp" id="nohp" class="form-control" placeholder="No. Telp./HP" required="">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="jenislayanan" style="width:100%;" id="jenislayanan" required="">
                                    <option value="">Pilih jenis tanah</option>

                                    <?php foreach ($layanan->result() as $key) { $i=1;?>

                                        <option value="<?php echo $key->idlayanan ?>"><?php echo $key->nama_l ?></option>
                                ...
                                <div class="form-group">
                                    <label>Pilih Status Kepemilikan Tanah</label>
                                    <select class="form-control" name="statusp" style="width:100%;" id="statusp" required="">
                                        ...
                                        <option value="Sudah Sertifikat">Sudah Sertifikat</option>
